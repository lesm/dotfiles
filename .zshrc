...
plugins=(git rails ruby docker docker-compose)
...
# brew install coreutils (GNU coreutils) if gls exists coreutils is already installed
...
if command -v gls >/dev/null; then
  ...
  # Fallback to BSD ls
  export LSCOLORS="ExGxFxDxCxEgEdxbxgxcxd"
  export CLICOLOR=1
fi
